...
public class MemcachedManager {
    ...
    public void init() {
        ...
        mainMemcachedDaemon.setCache(new CacheImpl(new DefaultInfiniBridge(clientManager.getPrimaryCache())));
        ...
        sessionMemcachedDaemon.setCache(new CacheImpl(new DefaultInfiniBridge(clientManager.getSecondaryCache())));
